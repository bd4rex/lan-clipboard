...
前端回归测试需要 Node.js 20 或更新版本，不需要安装 npm 包；生产服务仍只需要 Python。

Frontend regression tests require Node.js 20 or newer and no npm packages; the production service still requires only Python.
